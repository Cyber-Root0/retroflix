...
<?php
    ...
    if ( $_SERVER['REQUEST_METHOD'] == "POST" ){
        ...
        if ($result) {
            header('Location: /cliente/minha-conta/');
        }else{
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col-auto col-md-9 ms-5 mt-4 bg-light py-3">
                ...
                <nav class="mt-4 mb-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Meu Perfil</a></li>
                        ...
                        <div class="d-grid gap-3 d-fill">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 flex-fill">
                                    ...
                                    <input type="email" name="email" readonly id="email" value="<?= $dados_cliente['email'] ?>" required class="form-control">
                                </div>

                                <div class="form-group col-md-3 flex-fill">
                                    <label for="cpf">CPF</label>
                                    <input type="text" name="cpf" id="cpf" readonly required value="<?= $dados_cliente['cpf'] ?>" class="form-control">
                                </div>
                            </div>
