...
<?php
    ...
    if(isset($_POST["update"])) {
        ...
        $result = $filme->update($filmeEntity);
        if ($result){
            header("Location: /admin/dashboard/filmes/");
        }
                        ...
                        <div class="d-grid gap-3 d-fill">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3 flex-fill">
                                    ...
                                    <input type="text" name="titulo" id="titulo" required class="form-control" value="<?= $dados_filme['titulo']?>">
                                </div>

                                <div class="form-group col-md-3 flex-fill">
                                    <label for="dtNascimento" >Data de Lançamento</label>
                                    <input type="date" name="dtlancamento" required id="dtlancamento" class="form-control" value="<?= $dados_filme['data_lancamento']?>">
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3 flex-fill">
                                    ...
                                    <textarea class="form-control" id="sinopse" name="sinopse" rows="3"> <?= $dados_filme['sinopse']?> </textarea>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="url" name="link" required id="link" class="form-control" value="<?= $dados_filme['link']?>">
                                </div>
                            ...
                            <div class="d-flex justify-content-end pt-3">
                                <div class="col-md-2 ">
                                    <input type="submit" name="update" class="w-100 btn  btn-primary" value="Atualizar Filme">
                                </div>
                            </div>
                        </div>
